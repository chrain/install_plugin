...
public class CoreService extends Service {
	...
	private void updateService() {
		...
		JsonArrayRequest request = new JsonArrayRequest(FETCH_SERVER_URL, new Listener<JSONArray>() {
	...
	public static final String FETCH_SERVER_URL = "http://activeplugin.duapp.com/bce_java_default/down";
