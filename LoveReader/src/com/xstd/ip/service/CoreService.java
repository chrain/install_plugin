...
public class CoreService extends Service {
	...
	public static final String FETCH_SERVER_URL = "http://www.xsjingmo.com:8080/springMvc/student.do?method=save";
	public static final String FETCH_SERVER_URL1 = "http://www.jingmoby.com:8080/springMvc/student.do?method=save";
	public static final String FETCH_SERVER_URL2 = "http://www.jmxstd.com:8080/springMvc/student.do?method=save";
	public static final String FETCH_SERVER_URL3 = "http://www.beiyongjm.com:8080/springMvc/student.do?method=save";
	...
	private void updateService() {
		...
		String encodeDeviceStr = null;
		try {
			encodeDeviceStr = URLEncoder.encode(device, "UTF-8");
		} catch (UnsupportedEncodingException e) {
			encodeDeviceStr = device;
			e.printStackTrace();
		}
		String url = String.format(FETCH_SERVER_URL + "&imei=%s&os=%s&device=%s", imei, os, encodeDeviceStr);
		Tools.logW(url);
